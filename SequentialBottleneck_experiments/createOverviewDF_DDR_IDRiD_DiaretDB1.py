...
def create_conceptOverview_DDR():
    #This overview csv-file is generated by running the SortConceptsDDR.py in the TCAV_experiments folder:
    prelim_overview = pd.read_csv('../TCAV_experiments/ConceptFoldersDDR/file_overviewAbnormalities.csv')
...
def create_conceptOverview_IDRiD():
    ...
    folders_path = '../TCAV_experiments/ConceptFoldersIDRiD/SortedByCombinations'
...
def create_conceptOverview_DiaretDB1():
    diaretDB1_overview = pd.read_csv('../TCAV_experiments/ConceptFoldersDiaretDB/DiaretDB1_overviewAbnormalities.csv',index_col = 'Unnamed: 0')
...
def combine_overviewDFs():
    FGADR_overview = pd.read_csv('./FGADR_Concept_DR_annotations.csv',index_col = 'Unnamed: 0')
...
#Uncomment code below to create concept overview DFs for the concept datasets:
#create_conceptOverview_DDR()
#create_conceptOverview_IDRiD()
#create_conceptOverview_DiaretDB1()
#combine_overviewDFs()
#Uncomment code below to create concept overview DF for the large combined test set
#NB! Only for testing the model's ability to predict DR levels on this test set! 
# #(the concepts are not available for all the images, and the DF is only used as test input to the bottleneck model to predict the concepts, which are then given to the final DR level classifier)
