...
#Code for training the model on four concepts using FGADR, IDRiD, DDR and DiaretDB1 datasets.
...
class Dataset(BaseDataset):
    """CamVid Dataset. Read images, apply augmentation and preprocessing transformations.
     ...
     Args:
        ...
        concept_df (DataFrame): DF with image name, 4 concept annotations and DR level
...
output_path = "../output"
#Define the name to save the model as:
