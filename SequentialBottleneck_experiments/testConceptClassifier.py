...
####################
# This code evaluates the bottleneck model's performance in predicting all six concepts from images
####################
...
if __name__ == "__main__":
    ...
    #Create one large list for appropriate accuracies, since we have multilabel multiclass classification...
